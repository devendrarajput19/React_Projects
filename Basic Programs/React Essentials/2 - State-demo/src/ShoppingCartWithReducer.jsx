...
// defines the reducer function and it returns new state
...
export const ShoppingCartWithReducer = () => {
  const [state, dispatch] = useReducer(reducer, initialState); // useReducer returns 2 outputs. State and dispatch

  const products = [
    { id: 1, name: "React Course", price: 49.99 },
    { id: 2, name: "Node js Course", price: 69.99 },
